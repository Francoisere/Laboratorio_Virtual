...
El informe técnico detallado (arquitectura completa, configuración paso a paso, evidencia y conclusiones) está disponible en [`/docs/Informe_Laboratorio.docx`](docs/Informe_Laboratorio.docx).
